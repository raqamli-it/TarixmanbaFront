        ...
        >
          ...
          <div className="p-5 flex flex-col h-1/2 text-center gap-5 justify-between bg-[#424242b4] text-white">
            ...
            <div className="flex justify-between items-center">
              <button
                onClick={() => navigate(-1)}
                className="w-30 hover:text-red-600 hover:text-[17px] h-[38px] transition duration-500 ease-in-out transform bg-blue-500 md:w-1/3 flex justify-center font-semibold items-center w-1/5 overflow-hidden"
              >
                Orqaga
              </button>
              <span>
