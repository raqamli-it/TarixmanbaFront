...
export default function LibraryCategoryDetail() {
  ...
  const handleDownload = (fileUrl) => {
    ...
    element.setAttribute("download", fileUrl.split("/").pop()); // Fayl nomini URL'dan ajratib olish
    document.body.appendChild(element); // Elementni sahifaga qo'shish
    element.click(); // Yuklab olishni boshlash
          ...
          >
            ...
            <div className="flex justify-between items-center p-4 border-t">
              ...
              >
                ...
                <span className="ml-3 text-matn-color lg:text-[17px]">7.7k</span>
              </button>

              <button className="btn lg:text-[28px] text-[20px] m-4 " onClick={() => document.getElementById('1').showModal()}><FaShareFromSquare /></button>

              <dialog id="1" className="modal w-full bg-transparent h-full m-auto  ">
                  {/*modal share */}
                  <div className="h-full bg-transparent flex flex-col items-center justify-center">
                    <div className="bg-[#0e1311d7] w-full mx-4 p-4 rounded-xl md:w-1/2 lg:w-1/3">
                      <form form method="dialog" className=" w-[100%] flex justify-end">
                        <button className="btn text-[30px] text-[#db3c3c]"><IoCloseOutline /></button>
                      </form>
                      <div className="my-4">
                        ...
                        <div className="border-2 border-[#ccc] rounded flex justify-between items-center mt-4 py-2">
                          ...
                          <input id="hs-clipboard-input" className="w-full outline-none bg-transparent text-white " type="text" placeholder="link"
